...
const Ended = () => {
  ...
  const Form = () => activeStep === 0 
        ...
        : <PaymentForm shippingData={shippingData} checkoutToken={checkoutToken} backStep={backStep} nextStep={nextStep} handleCaptureCheckout={handleCaptureCheckout} timeout={timeout} />
